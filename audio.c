...
#define DATA3_L(x) ((x)+16)
#define DATA3_R(x) ((x)+20)
#define DATA4_L(x) ((x)+24)
#define DATA4_R(x) ((x)+28)
...
static void read_audio(audio_t *audio)
{
	...
	audio->left3 = ioread32(DATA3_L(dev.virtbase));
	audio->right3 = ioread32(DATA3_R(dev.virtbase));
	audio->left4 = ioread32(DATA4_L(dev.virtbase));
	audio->right4 = ioread32(DATA4_R(dev.virtbase));
